    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="javascript:;" data-toggle="collapse" data-target="#demo_dm"><i class="fa fa-fw fa-file"></i> 2 <i class="fa fa-fw fa-caret-down"></i></a>
                    <ul id="demo_dm" class="collapse">
                        <li>
                            <a href="#">Thêm mới</a>
                        </li>
                ...
                <li>
                    <a href="javascript:;" data-toggle="collapse" data-target="#demo_vd"><i class="fa fa-fw fa-file"></i> 1 <i class="fa fa-fw fa-caret-down"></i></a>
