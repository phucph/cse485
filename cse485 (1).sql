...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2018 at 12:36 PM
...
(30, 'tèn ten ten', 'Mot trong nhung thuat toan huu ich', 'Noi dung xoay quanh phan tich thuat toan ', 1, 'upload/shattered-dark.png', 'upload/review.html', '2018-10-29', 4, 1);
...
--
ALTER TABLE `nhatky`
  MODIFY `nk_id` int(11) NOT NULL AUTO_INCREMENT;
